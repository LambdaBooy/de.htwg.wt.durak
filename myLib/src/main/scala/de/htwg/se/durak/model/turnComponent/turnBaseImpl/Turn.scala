...
case class Turn(attacker: PlayerInterface, victim: PlayerInterface, neighbour: PlayerInterface,
  ...
  def this(attacker: PlayerInterface, victim: PlayerInterface, neighbor: PlayerInterface) = this(attacker: PlayerInterface, victim: PlayerInterface, neighbor: PlayerInterface, Nil, Map())
